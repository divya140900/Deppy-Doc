...
Original file is located at
    https://colab.research.google.com/drive/1tJIvWnxphjno6QhcHTdctOdg9FBvxFhM
"""
...
def extract_unformated_text(file_path):
  ...
  with open('/content/sample_data/unformatted_pdf_text_extracted.csv', "w") as f:
      writer = csv.writer(f)
      for row in rows:
          writer.writerow(row)
...
def extract_unformated_PDF_tables(file_path):
  ...
  folder_name = "/content/sample_data/"
...
# open the file
  ...
  for page_index in range(len(pdf_file)):
      ...
      for image_index, img in enumerate(image_list, start=1):
          ...
          image.save(open(f"/content/sample_data/image{page_index+1}_{image_index}.{image_ext}", "wb"))
