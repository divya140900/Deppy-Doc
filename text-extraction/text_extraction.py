...
#reading of image
image = cv2.imread('C:\\Users\\Divya\\OneDrive\\Desktop\\hackathon\\Cheque083654.jpg')
...
cv2.waitKey(0) 
#saving image
cv2.imwrite('C:\\Users\\Divya\\OneDrive\\Desktop\\hackathon\\image2_2.png',thresh1)
cv2.waitKey(0)
...
im = cv2.imread('C:\\Users\\Divya\\OneDrive\\Desktop\\hackathon\\image2_2.png', cv2.IMREAD_COLOR)
